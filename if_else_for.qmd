...
Bu örnekte, **`while`** döngüsü belirli bir koşul karşılanana kadar çalışır. **`durum`** değişkeni 5'ten büyük olduğunda **`FALSE`** yapılır ve döngü sonlanır. Her bir iterasyonda "Bekleme\..." yazdırılır ve **`Sys.sleep(1)`** fonksiyonu ile bir saniye bekletme işlemi yapılır.
